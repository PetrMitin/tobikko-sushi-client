...
const CustomNavbar: FC<{whatIsActive?: 'menu' | 'about-restaurant' | 'delivery-info' | 'basket'}> = ({whatIsActive}) => {
    ...
    const variant = dWidth > 940 ? 'full' : 'shrinked'
    const isPhoneDisplayed = dWidth > 580
        ...
        return (
            <Navbar bg="dark" variant="dark" id="navbar" className={isPhoneDisplayed ? 'navbar-row' : 'navbar-col'}>
                ...
                <div className="navbar-header">
                    ...
                    <Navbar.Brand href="/">
                        <Image 
                        src="https://e.mail.ru/cgi-bin/getattach?file=main-logo.jpeg&id=16560738290497813673%3B0%3B1&mode=attachment&x-email=sushi-shiso-confirm%40inbox.ru" 
                        alt="logo" 
