        ...
        <div className="footer" id="footer">
            ...
            <div className="footer-container w-100">
                <div className="footer-col">
                    ...
                    <Nav.Link href="#footer">МОБИЛЬНЫЕ ПРИЛОЖЕНИЯ</Nav.Link>
                    <span className='mobile-apps-link'>
                        <Nav.Link href="https://apps.apple.com/us/app/tobikko-sushi/id1666253447?uo=4" target="_new">
                            <img src="https://foodsoul.pro/images/marketing/stores/apple/3.svg"/>
                        </Nav.Link>
                        <br/>
                        <Nav.Link href="https://play.google.com/store/apps/details?id=ru.foodsoul.c7734v2" target="_new">
                            <img src="https://foodsoul.pro/images/marketing/stores/google/3.svg"/>
                        </Nav.Link>
                        <br/>
                        <Nav.Link href="https://appgallery.huawei.com/app/C107601017" target="_new">
                            <img src="https://foodsoul.pro/images/marketing/stores/huawei/1.svg"/>
                        </Nav.Link>
                    </span>
                </div>
                <div className="footer-col">
